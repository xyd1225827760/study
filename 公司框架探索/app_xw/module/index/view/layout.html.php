                                        ...
                                        <div class="sidebar-row">
                                            <ul class="sidebar-list-info list-unstyled">
                                                <li class="mbm" style="border-bottom: 1px solid rgba(153, 153, 153, 0.32)">
													...
													<a class="btn btn-info" data-toggle="tab" role="tab" href="#tab-compose"><i class="fa fa-file-o"></i>&nbsp;新建计划</a>
													</div>
                                                </li>
                                                <li class="active"><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-inbox">全部 (5)</a></li>
                                                <li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-sent">草稿</a></li>
                                                <li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-drafts">完成 (3)</a></li>
                                                <li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-sent">取消</a></li>
												<li style="border-top: 1px solid rgba(153, 153, 153, 0.32)"><h4 class="mtl mbm" style="padding-left: 15px;">计划分类</h4></li>
												<li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-inbox"><span class="mrs badge badge-success" style="display: inline"></span>日计划</a>
												<li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-sent"><span class="mrs badge badge-warning" style="display: inline"></span>周计划</a>
												<li class=""><a class="btn-group dropup btn-block" data-toggle="tab" role="tab" href="#tab-drafts"><span class="mrs badge badge-info" style="display: inline"></span>月计划</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mail-main tab-content">
                                        <div class="tab-pane fade pdm" id="tab-compose">
                                            <ul class="list-group mail-action list-unstyled list-inline mbm">
												<li><h3 class="mbs mlx plm mtm" style="color: #222">日计划管理</h3></li>
                                                <li class="pull-right"><a class="btn btn-default" data-original-title="Save Draft" data-hover="tooltip" href="#"> <i class="fa fa-floppy-o"></i></a><a class="btn btn-default" data-original-title="Move to" data-hover="tooltip" href="#"> <i class="fa fa-folder"></i></a><a class="btn btn-default" data-original-title="Trash" data-hover="tooltip" href="#"> <i class="fa fa-trash-o"></i></a></li>
                                            </ul>
