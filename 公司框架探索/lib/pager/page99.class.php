...
private function subPageCss4(){
	...
	if($this->current_page > 1){
		$firstPageUrl=$this->subPage_link."1";
		$prewPageUrl=$this->subPage_link.($this->current_page-1);
		$subPageCss3Str.="<li class='previous-on'><a href='$prewPageUrl'>&laquo;上一页</a></li> ";
	}else {
		$subPageCss3Str.="<li class='previous-off'>&laquo;上一页</li> ";
	}
	...
	if($this->current_page < $this->page_nums){
		$lastPageUrl=$this->subPage_link.$this->page_nums;
		$nextPageUrl=$this->subPage_link.($this->current_page+1);
		$subPageCss3Str.=" <li class='next'><a href='$nextPageUrl'>下一页 &raquo;</a></li> ";
	}else {
		$subPageCss3Str.="<li class='next-off'>下一页 &raquo;</li> ";
	}
	$subPageCss3Str .= "<li class='next-off'>共有".$this->nums."条记录，当前第".$this->current_page."/".$this->page_nums."页</li>";
	$this->page_html = $subPageCss3Str;
}
