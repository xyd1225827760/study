    ...
    */
    ...
    public function connect() {
        if (!isset($this->link) ) {
            ...
            $this->link->setAttribute(PDO::ATTR_ERRMODE, $config->errorMode);
			$this->link->exec("SET NAMES {$config->encoding}");
    ...
    */
    ...
    public function getFields($tableName) {
        ...
        $sql = "SELECT
			...
			WHERE
			  TABLE_NAME = :tabName AND TABLE_SCHEMA='".$this->config->db->name."'";
